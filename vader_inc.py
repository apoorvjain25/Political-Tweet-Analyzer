...
plt.show()
#plt.savefig(os.path.join('aap_results.png'), dpi=300, format='png', bbox_inches='tight') 
#################
...
def plot_classification_report(classification_report, title='Classification report(INC Dataset) ', cmap='RdBu'):
...
plt.savefig('test_plot_classif_report_inc.png', dpi=200, format='png', bbox_inches='tight')
plt.close()
