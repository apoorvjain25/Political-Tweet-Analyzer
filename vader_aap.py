...
def plot_classification_report(classification_report, title='Classification report(AAP Dataset) ', cmap='RdBu'):
...
plt.savefig('test_plot_classif_report_aap.png', dpi=200, format='png', bbox_inches='tight')
plt.close()
